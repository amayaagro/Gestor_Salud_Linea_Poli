...
if(isset($_GET['cancel']))
		  {
                  ...
                  $_SESSION['msg']="¡Su cita ha sido candelada!";
		  }
?>
...
<head>
    <title>Paciente | Historial de Citas</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Paciente | Historial de Citas</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Paciente </span>
