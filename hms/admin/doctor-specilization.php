...
$_SESSION['msg']="¡La Especialidad fue Agregada Satisfactoriamente!";
}
...
<head>
    <title>Administrador | Especialidad Médico</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Agregar Especialidad</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="panel panel-white">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">Especialidades</h5>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15">Gestionar <span class="text-bold">Especialidad Médico</span></h5>
