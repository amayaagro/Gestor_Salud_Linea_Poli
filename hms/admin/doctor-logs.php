...
<head>
    <title>Administrador | Registro de Sesiones Médicos</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Registro de Sesiones Médicos</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                ...
                                <li class="active">
                                    <span>Registro de Sesiones Médicos</span>
                                </li>
                            </ol>
                        </div>
                    </section>
