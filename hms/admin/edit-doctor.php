...
if($sql)
{
$msg="¡Datos de Médico Actualizados Satisfactoriamente!";
...
<head>
    <title>Administrador | Editar Datos Médico</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Editar Datos Médico</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="panel panel-white">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">Editar Datos Médico</h5>
                                            </div>
