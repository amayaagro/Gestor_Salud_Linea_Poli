...
<head>
    <title>Administrador | Gestión de Médicos</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Gestión de Médicos</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15">Gestión <span class="text-bold">Médicos</span>
                                </h5>
