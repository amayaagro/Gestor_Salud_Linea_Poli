...
<head>
    <title>Administrador | Gestión de Lectura de Mensajes</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Gestión de Lectura de Mensajes</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                   ...
                   <!-- Fin del Titulo de la Página -->
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15">Gestión <span class="text-bold">Mensajes Leidos</span></h5>
