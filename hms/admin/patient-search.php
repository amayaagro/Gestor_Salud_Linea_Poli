...
<head>
    <title>Administrador | Vista Pacientes</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Vista Pacientes</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
...
$sdata=$_POST['searchdata'];
  ?>
                                <h4 align="center">Resultado Opuesto"<?php echo $sdata;?>" Palabra Clave </h4>
...
$cnt=$cnt+1;
                                        ...
                                        <tr>
                                            <td colspan="8"> No se ha encontrado ninguna coincidencia</td>
