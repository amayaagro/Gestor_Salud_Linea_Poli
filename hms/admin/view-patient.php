...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
    ...
    if ($query) {
    echo '<script>alert("¡La Historia clínica ha sido agregada!")</script>';
    echo "<script>window.location.href ='manage-patient.php'</script>";
  }
  else
    {
      echo '<script>alert("¡Algo salío mal!. Intente de nuevo")</script>';
    }
}
...
<head>
    <title>Médico | Gestión de Pacientes</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Médico | Gestión de Pacientes</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Médico</span>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15">Médico <span class="text-bold">Gestión de
                                        Pacientes</span></h5>
                                <?php
                               $vid=$_GET['viewid'];
                               ...
                               ?>
                                <table border="1" class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>Fecha de Registro Paciente</th>
...
$ret=mysqli_query($con,"select * from tblmedicalhistory  where PatientID='$vid'");
 ...
 ?>
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tr align="center">
                                        <th colspan="8">Historia Clinica</th>
                                    </tr>
                                    <tr>
                                        <th>#</th>
