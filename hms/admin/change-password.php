...
check_login();
date_default_timezone_set('Asia/Kolkata');// Cambio de Acuerdo a la Zona Horaria del país
...
$_SESSION['msg1']="¡Clave Cambiada Satisfactoriamente!";
}
else
{
$_SESSION['msg1']="¡La Clave Antigua No Coincide!";
}
}
?>
...
<head>
    <title>Administrador | Cambio de Clave</title>
    <meta charset="utf-8" />
    <meta name="viewport"
    ...
    function valid() {
        if (document.chngpwd.cpass.value == "") {
            ...
            alert("¡Confirma la Contraseña Vacia!");
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Cambio de Clave</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
