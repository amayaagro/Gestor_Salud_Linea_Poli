	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<h2>Administrador Inicio Sesión</h2>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<p>
								Por favor entre su nombre y su contraseña.<br />
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> GSL</span>. <span>Todos los derechos resevados</span>
					</div>
