...
if($sql)
{
echo "<script>alert('¡Información del Médico Agregada Satisfactoriamente!');</script>";
...
<head>
    <title>Administrador | Agregar Médico</title>
    ...
    function valid() {
        if (document.adddoc.npass.value != document.adddoc.cfpass.value) {
            alert("¡La Clave y La Confirmación de la Clave no Conciden!");
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Administrador | Agregar Médico</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="panel panel-white">
                                            <div class="panel-heading">
                                                <h5 class="panel-title">Agregar Médico</h5>
                                            </div>
...
?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="docname" class="form-control"
                                                            placeholder="Nombre Médico" required="true">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="clinicaddress" class="form-control"
                                                            placeholder="Dirección" required="true"></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="fess">
                                                        ...
                                                        <input type="text" name="docfees" class="form-control"
                                                            placeholder="Valor de la Consulta" required="true">
                                                    </div>
