...
check_login();
date_default_timezone_set('South America/Colombia');
...
{
$_SESSION['msg1']="¡Contraseña Actual Incorrecta!";
}
}
?>
...
<head>
    <title>Médico | Cambio de Clave</title>
    ...
    function valid() {
        if (document.chngpwd.cpass.value == "") {
            alert("¡La Comtraseña Esta Vacia!");
            document.chngpwd.cpass.focus();
            return false;
        } else if (document.chngpwd.npass.value == "") {
            alert("¡La Nueva Contraseña está Vacia!");
            document.chngpwd.npass.focus();
            return false;
        } else if (document.chngpwd.cfpass.value == "") {
            alert("¡La Contraseña De Confirmación está Vacia!");
            document.chngpwd.cfpass.focus();
            return false;
        } else if (document.chngpwd.npass.value != document.chngpwd.cfpass.value) {
            alert("¡La Contraseña y La Confirmación de Contraseña no Coindicen!");
            document.chngpwd.cfpass.focus();
            return false;
        }
        return true;
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Médico | Cambio de Clave</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Médico</span>
