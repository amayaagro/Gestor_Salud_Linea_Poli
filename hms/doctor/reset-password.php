...
if ($query) {
echo "<script>alert('Contraseña Actualizada Satisfactoriamente');</script>";
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> GSL | Recuperar Clave del Paciente</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" name="passwordreset" method="post" onSubmit="return valid();">
						<fieldset>
							<legend>
								Recuperar Clave del Paciente
							</legend>
							<p>
								Por favor escriba su nueva contraseña .<br />
...
<div class="form-group">
<span class="input-icon">
<input type="password" class="form-control"  id="password_again" name="password_again" placeholder="Confirma Clave" required>
<i class="fa fa-lock"></i> </span>
</div>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> GSL</span>. <span>Todos los derechos reservados</span>
					</div>
